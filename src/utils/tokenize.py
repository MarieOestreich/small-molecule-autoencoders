# this code is originally from https://github.com/jixing475/pysmilesutils/blob/master/pysmilesutils/tokenize.py
# and was distributed under the Apache License 2.0 License https://github.com/jixing475/pysmilesutils/blob/master/LICENSE 
...
class SMILESTokenizer:
    ...
    def convert_encoding_to_ids(
        ...
        for encoding in encoded_data:
            ...
            ids = ids.type_as(encoding)
            t_ids = t_ids.type_as(encoding)
            ids[indices] = t_ids
            id_data.append(ids)
